      ...
      <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
        ...
        {showAwareness && (
          ...
          >
            ...
            <p>
              La pérdida de biodiversidad es un problema crítico que afecta a todo el planeta.
              Cada especie perdida reduce la resiliencia de los ecosistemas y compromete los
              servicios vitales que estos nos proporcionan, como la purificación del aire y
              agua, la polinización de cultivos y la regulación del clima. Es fundamental
              actuar ahora para conservar y restaurar los hábitats naturales, proteger las
              especies en peligro y promover prácticas sostenibles que garanticen un futuro
              saludable para las próximas generaciones.
            </p>
            <button
