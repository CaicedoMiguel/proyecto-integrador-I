  ...
  return (
    <div style={{ width: '100vw', height: '100vh' }}>
      ...
      <div className="titu">
        ...
        Desde un punto de vista humano, la diversidad biológica es clave para la alimentación, la medicina y el bienestar general. La pérdida de biodiversidad puede tener consecuencias graves, como la disminución de recursos naturales, la pérdida de hábitats y el aumento de enfermedades. Por lo tanto, conservar la biodiversidad es crucial no solo para la naturaleza, sino también para el futuro de la humanidad.
        </p>
      </div>
    </div>
  );
